...
describe('HomeComponent (unit-level)', () => {
  ...
  it('onPaste does NOT call HistoryService.recordPaste when signed out', async () => {
    const fixture = TestBed.createComponent(HomeComponent);
  ...
  it('onPaste calls HistoryService.recordPaste once when signed in', async () => {
    const fixture = TestBed.createComponent(HomeComponent);
  ...
  it('onPaste swallows HistoryService.recordPaste errors', async () => {
    const fixture = TestBed.createComponent(HomeComponent);
    const auth = TestBed.inject(AuthService);
    const { signInFakeUser } = await import('../../../testing/auth.testing');
    signInFakeUser(auth);
