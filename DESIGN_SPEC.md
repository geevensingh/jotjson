...
- **0.20.0**: Decoded value viewer dialog (issue #95 Phase 0). The
  ...
  matTooltip content is now clamped at 1024 characters with a
  localized truncation suffix that points at the dialog viewer.
